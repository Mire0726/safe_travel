...
var EventWhere = struct {
	...
	CreatedBy: whereHelperstring{field: "`events`.`created_by`"},
...
type eventR struct {
	...
	Transports    TransportSlice `boil:"Transports" json:"Transports" toml:"Transports" yaml:"Transports"`
}
...
func (r *eventR) GetCreatedByUser() *User {
	if r == nil {
		return nil
	}
...
func (r *eventR) GetTransports() TransportSlice {
	if r == nil {
		return nil
	}
	return r.Transports
...
var (
	eventAllColumns            = []string{"id", "name", "created_by", "created_at", "updated_at"}
	eventColumnsWithoutDefault = []string{"id", "name", "created_by", "created_at", "updated_at"}
...
func (q eventQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Event, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for events")
	}
...
func (q eventQuery) All(ctx context.Context, exec boil.ContextExecutor) (EventSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to Event slice")
	}
...
func (q eventQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count events rows")
	}
...
func (q eventQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if events exists")
	}
...
func (o *Event) CreatedByUser(mods ...qm.QueryMod) userQuery {
...
// Transports retrieves all the transport's Transports with an executor.
func (o *Event) Transports(mods ...qm.QueryMod) transportQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`transports`.`event_id`=?", o.ID),
	)

	return Transports(queryMods...)
}

// LoadCreatedByUser allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (eventL) LoadCreatedByUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
...
// LoadTransports allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (eventL) LoadTransports(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
	...
	query := NewQuery(
		qm.From(`transports`),
		qm.WhereIn(`transports.event_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load transports")
	}

	var resultSlice []*Transport
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice transports")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on transports")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for transports")
	}
	...
	if singular {
		object.R.Transports = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &transportR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.EventID {
				local.R.Transports = append(local.R.Transports, foreign)
				if foreign.R == nil {
					foreign.R = &transportR{}
				}
...
// SetCreatedByUser of the event to the related item.
// Sets o.R.CreatedByUser to related.
// Adds o to related.R.CreatedByEvents.
func (o *Event) SetCreatedByUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
...
// AddTransports adds the given related objects to the existing relationships
// of the event, optionally inserting them as new records.
// Appends related to o.R.Transports.
// Sets related.R.Event appropriately.
func (o *Event) AddTransports(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Transport) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.Transports = append(o.R.Transports, related...)
	}
...
func FindEvent(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Event, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from events")
	}
...
func (o *Event) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no events provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into events")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for events")
	}
...
func (o *Event) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update events, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update events row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for events")
	}
...
func (q eventQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for events")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for events")
	}
...
func (o EventSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in event slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all event")
	}
	return rowsAff, nil
}
...
func (o *Event) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no events provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert events, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for events")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for events")
	}
...
func (o *Event) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no Event provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from events")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for events")
	}
...
func (q eventQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no eventQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from events")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for events")
	}
...
func (o EventSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM `events` WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 0, eventPrimaryKeyColumns, len(o))
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from event slice")
	}
...
func (o *EventSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in EventSlice")
	}
...
func EventExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if events exists")
	}
